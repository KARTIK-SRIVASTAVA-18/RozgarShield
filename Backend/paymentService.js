/**
 * RozgarShield Payment Service — Razorpay Test Mode Integration
 * 
 * Handles payout order creation and verification via Razorpay.
 * Uses Razorpay Test Mode keys for demo environment.
 * 
...
async function createUpiPayout(amountInr, upiId, workerName, description) {
  ...
  return {
    ...
    status:      'processed',
    description: description || 'RozgarShield parametric insurance payout',
