...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  Future<void> _detectLocation() async {
    ...
    try {
      ...
      try {
        ...
        final resp = await http.get(url, headers: {'User-Agent': 'RozgarShield/1.0'});
      ...
      RichText(
        text: const TextSpan(
          ...
          children: [
            ...
            TextSpan(text: 'RozgarShield', style: TextStyle(color: gold)),
          ],
        ),
      ),
  ...
  Widget _step2() => Column(
    ...
    children: [
      ...
      _navyBtn(
        loading ? 'Activating...' : 'Activate RozgarShield →',
