...
class CertificateGenerator {
  ...
  static Future<void> generate({
      ...
      build: (pw.Context ctx) => pw.Column(
        ...
        children: [
            ...
            child: pw.Row(
              ...
              children: [
                pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
                  pw.Text('RozgarShield', style: pw.TextStyle(color: PdfColors.white, fontSize: 26, fontWeight: pw.FontWeight.bold)),
          ...
          pw.Center(child: pw.Text(
            'This document is evidence of your income protection cover with RozgarShield.\nPlease keep it safe. Coverage is valid for the period shown below.',
          ...
          pw.SizedBox(height: 6),
          pw.Text(
            'This document outlines the terms and conditions of the income protection coverage provided by RozgarShield to the policyholder, $workerName, under policy number $policyNo. The client number associated with this policy is $clientNo.\n\nCoverage under this policy begins on $startDate and remains effective until $endFmt, provided that the weekly premium of ₹$weeklyPremium has been paid in full. The maximum payout under this policy is ₹$maxPayout / week. Payouts are triggered automatically upon verified parametric events — no manual claim filing is required by the worker.\n\nThe policyholder may cancel coverage at any time via the RozgarShield app. RozgarShield reserves the right to suspend coverage in the event of verified fraudulent activity, including GPS spoofing, duplicate claim submissions, or misrepresentation of delivery zone.',
          ...
          pw.Row(
            ...
            children: [
              pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
                pw.Text('RozgarShield', style: pw.TextStyle(fontSize: 9, fontWeight: pw.FontWeight.bold, color: navyColor)),
              ...
              pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.center, children: [
                ...
                pw.Text('RozgarShield Auto-System', style: pw.TextStyle(fontSize: 9, fontWeight: pw.FontWeight.bold, color: navyColor)),
          ...
          pw.SizedBox(height: 8),
          pw.Center(child: pw.Text(
            'Page 1 of 1 · RozgarShield Income Protection Certificate · $policyNo',
    ...
    await Printing.layoutPdf(
      ...
      name: 'RozgarShield_Certificate_$policyNo.pdf',
    );
  }
