...
class _AdminLoginState extends State<AdminLogin>
  ...
  final _emailCtrl = TextEditingController(text: 'admin@rozgarshield.com');
  ...
  Future<void> _login() async {
    ...
    bool ok = false;
    if (email == 'admin@rozgarshield.com' && pass == 'rozgarshield@2026') {
      ok = true;
    } else {
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        _credRow('Email',    'admin@rozgarshield.com'),
                        _credRow('Password', 'rozgarshield@2026'),
                      ],
                    ),
                  ),
                ],
